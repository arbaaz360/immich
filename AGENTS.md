...
Read `CUSTOMIZATION_CONTRACT.md` before changing Compose, database state, generated media behavior, album covers, or patched Immich files. Treat its invariants as user requirements, not implementation suggestions.
